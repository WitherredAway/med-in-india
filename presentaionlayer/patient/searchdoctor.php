...
<h1 class="heading"
	...
	Search <span style="text-transform: uppercase;color: var(--green);">Doctor</span></h1>
...
<body>
	...
	if (isset($_POST['Search'])) {
		...
		?>
		<table class="table2"
			style="border-collapse: collapse;width: 100%;color: #282828;font-family: monospace;font-size: 20px;text-align: center;margin-top: 220px;">
